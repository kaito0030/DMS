...
<form action="${pageContext.request.contextPath}/user-list"
    ...
    <select name="searchColumn"
        ...
        <option value="userName"
                ${searchColumn == 'userName' ? 'selected' : ''}>
            ユーザID
        </option>

        <option value="realName"
                ${searchColumn == 'realName' ? 'selected' : ''}>
            名前
        </option>

        <option value="userType"
                ${searchColumn == 'userType' ? 'selected' : ''}>
            ユーザ区分
        </option>
    ...
    <select name="keyword"
        ...
        <option value="admin"
                ${keyword == 'admin' ? 'selected' : ''}>
            管理ユーザ
        </option>

        <option value="general"
                ${keyword == 'general' ? 'selected' : ''}>
            一般ユーザ
        </option>
...
<div class="table-container">
    ...
    <table class="data-table">
        ...
        <tr>
            ...
            <th onclick="sortTable(1)" class="sortable-th">
                名前
            </th>

            <th onclick="sortTable(2)" class="sortable-th">
                ユーザ区分
            </th>
